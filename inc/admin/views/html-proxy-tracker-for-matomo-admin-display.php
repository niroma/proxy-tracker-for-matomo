...
<div class="wrap">
	...
	<form name="proxyTrackerForMatomo_tracker_settings" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
		<table class="form-table">	
            ...
            <?php /*
			<tr id="proxyTrackerForMatomoJsMode" valign="top">
				<th scope="row">
			...
			*/ ?>
			<tr id="proxyTrackerForMatomoJsDisallowRobot" valign="top">
				<th scope="row">
			...
			<tr valign="top">
				...
				<td>
					<input type="hidden" name="action" value="proxyTrackerForMatomo_tracker_form_response">
					<?php wp_nonce_field( $this->plugin_name.'submit-proxyTrackerForMatomo-form' ); ?>
